...
More specifically, I've chosen to implement a client that will perform the [Authorization Code Flow](https://openid.net/specs/openid-connect-core-1_0.html#CodeFlowAuth). It is [one of the two flows](https://leastprivilege.com/2019/09/09/two-is-the-magic-number/) we need to know to cover most of our application authentication needs. We will omit PKCE from our implementation, as we already have a lot of ground to cover implementing the flow. We will mostly adhere to [the supplied guidance](https://openid.net/specs/openid-connect-core-1_0.html#RPMTI) on what parts of the specification we must implement, but deviate a little at times to ensure we have a well-rounded understanding of the components of the solution.
